...
from dbt.contracts.graph.unparsed import UnparsedGenericTest
from dbt.contracts.graph.parsed import ParsedGenericTestNode
...
class GenericTestParser(BaseParser[ParsedGenericTestNode]):
    ...
    def parse_generic_test(
        self, block: jinja.BlockTag, base_node: UnparsedGenericTest, name: str
    ...
    def parse_unparsed_generic_test(
        self, base_node: UnparsedGenericTest
        ...
        for block in blocks:
            ...
            generic_test_nodes = list(ast.find_all(jinja2.nodes.Test))
